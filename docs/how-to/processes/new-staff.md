...
Please follow this process when new staff join your repository team.

1. Notify the Arca Office, and let us know:
    - The new user's contact information, including name, email, and title
    - What the new person's role is (are they ingesting/editing content; working on site configurations; managing the repository, etc.)
    - What communications they'll need to receive (e.g. the Arca Admins mailing list; ConsortiaManager billing contact)
2. Create an account for them in your repository with the appropriate role:
    - Go to `/admin/people` and add the new user
...
5. If the new user has further questions about the training or their tasks, they should contact the Arca Office; we will be happy to answer questions or meet with them if needed.